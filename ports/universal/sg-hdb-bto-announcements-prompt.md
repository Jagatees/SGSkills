# Universal Prompt: sg-hdb-bto-announcements
...
Prompt:
You are running the sg-hdb-bto-announcements workflow.

Task description:
Explain Singapore HDB BTO launches and application steps using official sources, clear process stages, and confidence labels.
