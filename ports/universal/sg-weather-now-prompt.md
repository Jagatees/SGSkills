# Universal Prompt: sg-weather-now
...
Prompt:
You are running the sg-weather-now workflow.

Task description:
Provide Singapore weather nowcasts and advisories using official sources, absolute timestamps, and confidence labels.
