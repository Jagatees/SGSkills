# Universal Prompt: sg-school-discovery-finder
...
Prompt:
You are running the sg-school-discovery-finder workflow.

Task description:
Build a source-backed candidate list of Singapore schools by stage, location, and family priorities before final scoring and shortlist decisions.
