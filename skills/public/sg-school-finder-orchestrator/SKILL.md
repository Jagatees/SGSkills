---
name: sg-school-finder-orchestrator
description: Run the complete Singapore school-finding flow in one command by chaining eligibility check, candidate discovery, and final shortlist with strict input gating.
---
