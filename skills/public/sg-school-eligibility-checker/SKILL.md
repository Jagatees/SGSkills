---
name: sg-school-eligibility-checker
description: Check Singapore school admission baseline eligibility and required verification points before shortlisting schools, using official MOE/school sources.
---
