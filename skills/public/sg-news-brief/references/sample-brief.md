...
1. Transport authority announces service reliability measures for major commuter lines - may reduce peak-hour disruptions.
2. New SME grants window opens for digital productivity upgrades - lowers upfront costs for adoption.
3. Health agency updates seasonal advisory - schools and workplaces asked to strengthen prevention messaging.
...
- Follow next agency release for detailed eligibility FAQs and exception cases.
...
- Sample structure only. Replace all placeholders with verified current stories and real source links.
- In production output, do not keep low-confidence items outside `Watchlist`.
