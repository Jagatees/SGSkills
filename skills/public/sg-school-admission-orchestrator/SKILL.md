---
name: sg-school-admission-orchestrator
description: Help Singapore parents shortlist suitable schools and plan admissions next steps using official MOE/school sources, explicit tradeoffs, and confidence-labeled guidance.
---
